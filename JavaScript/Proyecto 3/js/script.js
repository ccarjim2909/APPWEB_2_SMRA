...
const frasesFrikisInformatica = [ "Los programadores no tienen errores, solo experiencias inesperadas."
...
const btn = document.querySelector(".body__main__section__btn");

const frase = document.querySelector(".body__main__section__letras-fondo")
...
function color_fondo() {
    ...
    const randomColor = frasesFrikisInformatica[Math.floor(Math.random() * frasesFrikisInformatica.length)]; /* Variable que elige un numero entre 0 y 1 y 
                                                                            luego se multiplica por el numero que queremos de maximo 
                                                                            y sale uno entre ellos */
    // Aplicar colores
    frase.textContent = randomColor;
    btn.textContent = "Ver mas contenido";      
