...
$db_name = "prueba_aweb";      // Nombre de la base de datos creada
...
$sql = "SELECT * FROM `$db_table_name` WHERE correo = '$usuario'";
...
if (mysqli_num_rows($resultado) > 0) {
   ...
   $sql_insert = "INSERT INTO `$db_table_name` ( correo, nombre, apellido, contraseña) VALUES ('$usuario','$nombre','$apellido','$password')";
